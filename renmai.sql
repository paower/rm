...
CREATE TABLE `ysk_menu` (
  ...
  `status` tinyint(3) NOT NULL DEFAULT '0' COMMENT '状态',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=380 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `ysk_news` VALUES ('113', '这是一条最新公告', '', '0', '', '1568663874', '0', '财富人脉，火爆上线中', '', '0', '0', '1', '0');
...
CREATE TABLE `ysk_tranmoney` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=81690 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED;
...
) ENGINE=MyISAM AUTO_INCREMENT=779749 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of ysk_user
-- ----------------------------
INSERT INTO `ysk_user` VALUES ('778904', '0', '0', '0', '13211111111', '13211111111', '测试1', '', '84d51347732babc3a27562bebd1378ad', '84a', '84d51347732babc3a27562bebd1378ad', '84a', '0', '1558358861', '112.17.247.75', '1', '0', '6343m6cag46aefet7vh45r3lh6', '', '22', '-8570-8599-8641-8658-8732-8733-778892-', '5', 'toux-icon.png', 'test', '义乌1', '6', '6217001460009198283', '0.0000', '1560736410', '0', '0.0000', '0', '', '1', '0', '', '430281199306035928', '15669510603', 'L 031363', '12nR2K9HqgfF5rhvrWKjUV8VCGzo2txJbp', '1', '/Uploads/Payvos/5ce6431d1503d.jpg', '/Uploads/Payvos/5ce4e20d3365e.png', '1', '1', '0', '0', '16', '0', null, null);
